		...
		<div class="card" style="width: 18rem;">
  			<ul class="list-group">
  				...
  				<li class="dropdown-submenu list-group-item">
             		...
             		<ul class="dropdown-menu pull-right">
                  		<% for(String s:ml2){ %>
                  		<li class="list-group-item"><a href="/ecommerce/user/findlistbysfname?sfname=<%=s %>"><%=s %></a></li>
                 		<% } %>
                    </ul>
  				</li>
  				<li class="dropdown-submenu list-group-item">
             		...
             		<ul class="dropdown-menu pull-right">
                  		<% for(String s:ml3){ %>
                  		<li class="list-group-item"><a href="/ecommerce/user/findlistbyshopclass?shopclass=<%=s %>"><%=s %></a></li>
                 		<% } %>
                    </ul>
  				</li>
  				<li class="dropdown-submenu list-group-item">
 			 ...
 			 <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  				<div class="carousel-inner">
    				...
    				<div class="carousel-item active">
      					<img class="img-responsive d-block w-100"  src="/ecommerce/image/<%=photo.getPname() %>" alt="First slide">
    				</div>
    				<%  }else{  %>
    				<div class="carousel-item">
      					<img class="img-responsive d-block w-100" src="/ecommerce/image/<%=photo.getPname() %>" alt="<%=k%> slide">
   				    </div>
    				<% } k++; } } %>
				</div>
 		 	...
 		 	<div class="card" style="width: 400px;border: 0">
				<div class="card" style="width: 400px;">
					<a href="user/seeoneshop?shopname=<%=plist.get(i*3).getShopname() %>">
  					<img class="img-responseven w-100" src="/ecommerce/image/<%=plist.get(i*3).getPname() %>" alt="i*3">
  					</a>
  					<div class="card-body">
 		 	...
 		 	<div class="card" style="width: 400px;border: 0">
				<div class="card" style="width: 400px;">
					<a href="user/seeoneshop?shopname=<%=plist.get(i*3+1).getShopname() %>">
  					<img class="img-responseven w-100" src="/ecommerce/image/<%=plist.get(i*3+1).getPname() %>" alt="i*3+1">
  					</a>
  					<div class="card-body">
 		 	...
 		 	<div class="card" style="width: 400px;border: 0">
				<div class="card" style="width: 400px;">
					<a href="user/seeoneshop?shopname=<%=plist.get(i*3+2).getShopname() %>">
  					<img class="img-responseven w-100"
							src="/ecommerce/image/<%=plist.get(i*3+2).getPname() %>"
							alt="i*3+2">
						</a>
  					<div class="card-body">
